...
class Regressor():
    ...
    def _preprocessor(self, x, y = None, training = False):
        ...
        # --------------------------------------------------------------------
        # TESTED
        # new_data = pd.get_dummies(x.ocean_proximity)

        # x[x.columns] = new_data
    ...
    def score(self, x, y):
        ...
        return mse,ex_var,r2, rmse # Replace this code with your own
...
def RegressorHyperParameterSearch(x,y,folds = 5): 
    ...
    'max_epochs': list(range(50,100,500)), 
    'neurons': [[256,256,256,256,1]],
    'batch_size': [28, 56, 128]}
    epoch = 50
